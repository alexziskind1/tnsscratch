...
import { BehaviorSubject, Observable, of, asyncScheduler, interval, defer } from 'rxjs';
...
@Component({
    ...
    <StackLayout #pbVal col="0" class="progressbar-value" [style.width]="(percent$ | async) + '%'"></StackLayout>
