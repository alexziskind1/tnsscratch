...
function convertNavDataToObjects() {
    var navPageItems = navdata_1.pageNavData.map(function (i) {
        var linkItems = i.links.map(function (l) { return new linkItem_1.LinkItem(l.name, new rect_1.Rect(l.rect.origin.x, l.rect.origin.y, l.rect.size.width, l.rect.size.height), l.isBack); });
